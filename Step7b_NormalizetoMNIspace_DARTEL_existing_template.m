%% DARTEL EXISTING TEMPLATE NORMALIZE TO MNI SPACE
...
ses='ses-001';
anat='anat';
prep_folder='spm_us_cfm_new_TPM_med_reg_DARTEL_existing_template'; % Write your preprocessing folder name here
...
for sub=1:size(names,1)
    ...
    if sub==1 %Existing DARTEL template from IXI dataset imported from CAT12 to the folder from the first subject
